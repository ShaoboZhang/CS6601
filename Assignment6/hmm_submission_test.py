...
class TestPart2b(unittest.TestCase):
    ...
    def test_viterbi_case2(self, part_2_a, multidimensional_viterbi):
        ...
        seq, prob = multidimensional_viterbi(evidence, states, prior, trans, emiss)
    ...
    def test_viterbi_phrase2(self, part_2_a, multidimensional_viterbi):
        ...
        """
        right_y = [42, 40, 41, 43, 52, 55, 59, 60, 55, 47, 39, 32, 34, 36, 42, 42, 42, 34, 25]
        left_y = [138, 133, 123, 115, 104, 91, 76, 70, 67, 67, 62, 56, 48, 43, 43, 44, 46, 52, 65]
        evidence = list(zip(right_y, left_y))
