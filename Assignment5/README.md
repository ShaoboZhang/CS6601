...
Once execution is complete open autogenerated `submit/submission.py` and verify that it contains all of the imports, functions and classes you are required to implement. Only then you can proceed to the [Gradescope](https://www.gradescope.com/) for submission.
